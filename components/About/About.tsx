...
const About = () => {
  return (
    <section id='about' className='bg-(--color-bg) flex flex-col pt-[60px]! pb-20! px-4! sm:px-8! md:px-10! justify-center items-center gap-10 w-full'>
        <div className="flex flex-col justify-center items-center gap-2.5 w-full">
            ...
            <div className='w-full flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 lg:gap-7'>
                ...
                <div className='w-full max-w-sm sm:max-w-md lg:w-96 lg:h-[434px] mx-auto lg:mx-0'>
                    <Carousal />
                </div>
            </div>
        </div>
