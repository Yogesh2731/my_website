...
type CardProps = { projects: Project[] };
...
const TiltCard = ({ project }: { project: Project }) => {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    card.style.transform = `perspective(800px) rotateY(${x * 12}deg) rotateX(${-y * 12}deg) scale3d(1.05, 1.05, 1.05)`;
  };
  ...
  return (
    <div
      ...
      className="group w-full sm:w-[400px] lg:w-[520px] h-[220px] sm:h-[270px] lg:h-[317px] hover:h-[230px] sm:hover:h-[285px] lg:hover:h-[330px] relative bg-black/30 rounded-2xl overflow-hidden cursor-pointer"
      style={{ transition: 'transform 0.15s ease, height 0.3s ease', willChange: 'transform' }}
    >
      <Image
        src={project.img}
        alt={project.alt}
      ...
      <div
        className="w-full px-6! sm:px-8! lg:px-10! py-4! lg:py-5! absolute left-0 top-[148px] sm:top-[188px] lg:top-[205px] group-hover:top-8 sm:group-hover:top-14 lg:group-hover:top-20 h-64 bg-neutral-900/40 backdrop-blur-lg inline-flex flex-col justify-start items-start gap-3 lg:gap-4"
